package com.subeen.gallery.config;
...
public class AppConfig {
  ...
  public SqlSessionFactory sqlSessionFactory(
    ...
    // 
    sqlSessionFactoryBean.setTypeAliasesPackage("com.subeen.gallery.domain");
    sqlSessionFactoryBean.setMapperLocations(
        appCtx.getResources("classpath:com/subeen/gallery/mapper/*Mapper.xml"));
